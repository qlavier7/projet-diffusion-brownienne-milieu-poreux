...
def collide_forced(pops_pre, pops_post, F, rho, u, u_mag2, obstacle, Nx, Ny, Nz, 
...
#%% BGK Forced Collision
@nb.jit(nopython=True, parallel=True, fastmath=True)
def collide_forced_fluctuation(pops_pre, pops_post, F, rho, u, u_mag2, obstacle, Nx, Ny, Nz, 
...
# Calculate fluid properties and perform collisions
    if brownian_method == "fluctuation":
        collide_forced_fluctuation(pops_pre, pops_post, F, rho, u, u_mag2, obstacle, Nx, Ny, Nz, inv_cs2, inv_2cs2, inv_cs4, inv_2cs4, omega_S_coeff, N_vels, w, c, nu, kB_T)
    else:
        collide_forced(pops_pre, pops_post, F, rho, u, u_mag2, obstacle, Nx, Ny, Nz, inv_cs2, inv_2cs2, inv_cs4, inv_2cs4, omega, omega_prime, omega_S_coeff, N_vels, w, c)
