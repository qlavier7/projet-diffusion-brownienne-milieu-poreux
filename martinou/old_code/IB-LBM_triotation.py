...
output_gif_name = "triotation" # name of the output gif file (only if live_flow_plot=True)
...
init_marker_pos[2, 1] = cy_particle + 2.3*D_particle3
...
def lubrication_correction_forcing(N_markers, marker_pos, marker_vel, marker_radii, 
                              lubrication_threshold, marker_f):
    """
...
def run_diff_sim(pops_pre, pops_post, F, rho, u, u_mag_sq, N_markers, marker_pos, marker_vel, marker_f, marker_nh, marker_nh_size, 
    ...
    marker_f[1, 0] = -0.5*F_ini # initial force marker 2
    marker_f[1, 1] = 0.866*F_ini
    marker_f[2, 0] = -0.5*F_ini # initial force marker 3
    marker_f[2, 1] = -0.866*F_ini
    ...
    for t in iterations:
        ...
        if t==100:
            ...
            marker_f[1, 1] = 0
            marker_f[2, 0] = 0 # initial force marker 3
            marker_f[2, 1] = 0
    ...
    if live_flow_plot and len(frames) > 0:
        imageio.mimsave(f'{output_gif_name}.gif', frames, fps=15)
